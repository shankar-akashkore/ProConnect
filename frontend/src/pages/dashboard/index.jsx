            ...
            {postState.posts.map((post) => {
              ...
              <div key={post._id} className={styles.singleCard}>
                ...
                <div className={styles.singleCard_profile}>
                  <img className={styles.singleCard_profile_img} src={`${BASE_URL}/${post?.userId?.profilePicture}`} alt=''/>
                  <div style={{ flex: 1 }}>
                ...
                <div className={styles.singleCard_image}>
                  <img src={`${BASE_URL}/${post?.media}`} alt=''/>
                    ...
                    <div className={styles.optionsContainer}>
                      ...
                      className={`${styles.singleOption_optionContainer} ${post?.isLiked ? styles.singleOption_optionContainerActive : ''}`}>
                        {post?.isLiked ? (
                          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-6">
                            <path d="M1.5 10.5c0-1.246 1.01-2.25 2.25-2.25h3.586a1.5 1.5 0 0 0 1.423-1.025l1.132-3.394A2.25 2.25 0 0 1 12.026 2.25c.675 0 1.291.3 1.708.81.416.51.585 1.177.465 1.825l-.403 2.19a1.5 1.5 0 0 0 1.475 1.775h3.474c1.38 0 2.438 1.232 2.229 2.596l-.784 5.1A3.75 3.75 0 0 1 16.485 19.5H9a3.75 3.75 0 0 1-3.75-3.75V10.5H3.75A2.25 2.25 0 0 1 1.5 10.5Z" />
                            <path d="M5.25 10.5v5.25A2.25 2.25 0 0 1 3 18H2.25A.75.75 0 0 1 1.5 17.25v-6a.75.75 0 0 1 .75-.75h.75a2.25 2.25 0 0 1 2.25 2.25Z" />
                          </svg>
                        ) : (
                          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
                      ...
                      <div onClick= {() => {
                        ...
                        const url = encodeURIComponent("shankarakashkore.com");
